...
class CRM_Grant_BAO_Query {
  ...
  public static function buildSearchForm(&$form) {
    ...
    $form->addDate('grant_application_received_date_high', ts('To', array('context' => 'range')), FALSE, array('formatType' => 'searchDate'));
    ...
    $form->addDate('grant_money_transfer_date_high', ts('To', array('context' => 'range')), FALSE, array('formatType' => 'searchDate'));
    ...
    $form->addDate('grant_due_date_high', ts('To', array('context' => 'range')), FALSE, array('formatType' => 'searchDate'));
    ...
    $form->addDate('grant_decision_date_high', ts('To', array('context' => 'range')), FALSE, array('formatType' => 'searchDate'));
